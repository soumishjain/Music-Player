  ...
  return (
    <div className='flex overflow-x-auto gap-2  no-scrollbar'>
      {curr.map((e) => {
        ...
        className='flex group flex-shrink-0 p-2 h-full justify-center items-center rounded-xl hover:bg-white/10 transition-all ease duration-300 cursor-pointer flex-col'>
